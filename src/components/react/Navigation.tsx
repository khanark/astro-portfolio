                ...
                <AnimatePresence>
                    {dropDownMenu && (
                        <motion.div
                            ...
                            className="lg:hidden absolute h-screen top-0 left-0 bg-gray-100/90 dark:bg-gray-950/90 w-full flex justify-center items-center flex-col gap-4 text-full backdrop-blur-sm"
                        >
